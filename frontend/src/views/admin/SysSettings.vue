<template>
  <div class="sys-setting-panel">
    ...
    >
      <!--input输入-->
      <el-form-item label="title of register email" prop="registerEmailTitle">
        <el-input
          clearable
          placeholder="please enter the title of register email"
      ...
      <el-form-item label="initial space" prop="userInitUseSpace">
        <el-input
          clearable
          placeholder="初始空间大小"
