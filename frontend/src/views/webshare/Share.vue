          ...
          <div class="share-user-info">
            ...
            <div class="share-info">
              <div class="user-info">
                ...
                <span class="share-time">shared at {{ shareInfo.shareTime }}</span>
              </div>
              <div class="file-name">file shared：{{ shareInfo.fileName }}</div>
            </div>
          </div>
...
//cancel sharing
const cancelShare = () => {
  proxy.Confirm(`Are you sure to cancel sharing?`, async () => {
    let result = await proxy.Request({
      url: api.cancelShare,
      params: {
        shareIds: shareId,
    ...
    proxy.Message.success("cancelled successfully");
    router.push("/");
  });
};
