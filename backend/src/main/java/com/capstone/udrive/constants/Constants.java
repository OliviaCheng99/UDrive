package com.capstone.udrive.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "udrive:download:";

    public static final String REDIS_KEY_SYS_SETTING = "udrive:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "udrive:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "udrive:user:file:temp:";
